/**
 * Testklassen zum Testen der Klassen Fraction
 */
class FractionTest {
    /**
    ...
    /**
     * Testet die Division mit einem anderen Bruch incl. Sonderfall mit 0 im Zähler des Divisors.
     */
    void testDivide() {
        Fraction frac1 = new Fraction(1,2);
        Fraction frac2 = new Fraction(3,4);
        Fraction frac3 = new Fraction(0,4);
        assertBool( frac1.divide(frac2).getNumerator() == 4 && frac1.divide(frac2).getDenominator() == 6 , "Fehler in MultiplyDivide #1" );
        assertBool( frac1.divide(frac3) == null , "Fehler in MultiplyDivide #2" );
    }
